      ...
      <div className="bg-white dark:bg-gray-800 border border-red-200 dark:border-red-900 rounded-xl p-6">
        ...
        {!confirming ? (
          <button
            ...
            className="text-sm bg-red-50 dark:bg-red-950 text-red-600 border border-red-200 dark:border-red-800 px-4 py-2 rounded-lg hover:bg-red-100 dark:hover:bg-red-900 transition"
          >
            Delete Account
          </button>
        ) : (
          <div className="space-y-3">
            ...
            <input
              ...
              className="w-full border dark:border-gray-600 rounded-lg px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-red-400 text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-700"
            />
            ...
            <div className="flex gap-2">
              <button
                ...
                disabled={isPending}
                className="flex-1 border dark:border-gray-600 rounded-lg px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 transition disabled:opacity-40"
              >
                Cancel
              </button>
              <button
